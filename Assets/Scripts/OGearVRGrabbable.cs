...
/// <summary>
/// An object that can be grabbed and thrown by OGearVRGrabber.
/// </summary>
public class OGearVRGrabbable : MonoBehaviour
{
    [SerializeField]
    ...
    protected OGearVRGrabber m_grabbedBy = null;
    ...
    /// </summary>
    public OGearVRGrabber grabbedBy
    {
    ...
    /// </summary>
    virtual public void GrabBegin(OGearVRGrabber hand, Collider grabPoint)
    {
        m_grabbedBy = hand;
